 ...
 * <!-- end-user-doc -->
 * @see impModLang.ImpModLangPackage
 * @generated
 */
public class ImpModLangSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static ImpModLangPackage modelPackage;
	 ...
	 * @generated
	 */
	public ImpModLangSwitch() {
		if (modelPackage == null) {
			modelPackage = ImpModLangPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ImpModLangPackage.MODEL: {
				Model model = (Model)theEObject;
				T result = caseModel(model);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImpModLangPackage.ASSIGNMENT: {
			...
			case ImpModLangPackage.MARK: {
				Mark mark = (Mark)theEObject;
				T result = caseMark(mark);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImpModLangPackage.GOTO: {
			...
			case ImpModLangPackage.CONDITION: {
				Condition condition = (Condition)theEObject;
				T result = caseCondition(condition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImpModLangPackage.VARIABLE: {
				Variable variable = (Variable)theEObject;
				T result = caseVariable(variable);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImpModLangPackage.EXPRESSION: {
				Expression expression = (Expression)theEObject;
				T result = caseExpression(expression);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ImpModLangPackage.STATEMENT: {
