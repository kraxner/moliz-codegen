...
public class SimpleModelFactoryImpl extends EFactoryImpl implements SimpleModelFactory {
	...
	public static SimpleModelFactory init() {
		try {
			SimpleModelFactory theSimpleModelFactory = (SimpleModelFactory)EPackage.Registry.INSTANCE.getEFactory("http://www.SimpleModel"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case SimpleModelPackage.ACTIVITY: return createActivity();
			case SimpleModelPackage.ACTION: return createAction();
			default:
